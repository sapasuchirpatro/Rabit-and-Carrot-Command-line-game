...
while(1):   
    loss_or_win = input("What do you want to find win or loss. Enter 'w' for win and 'l' for loss: ").strip()
...
while(1):
    no_of_consecutive_wins_or_losses = int(input(f"Enter a number 'n' to print the team names having 'n' consecutive {value}: ").strip())
